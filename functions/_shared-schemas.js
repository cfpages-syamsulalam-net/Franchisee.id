...
export const EDITABLE_LISTING_FIELD_DEFS = [
  ...
  { name: "min_area_sqm", label: "Luas minimum (m²)", type: "integer" },
  { name: "min_staff_count", label: "Jumlah staff minimum", type: "integer" },
  ...
  { name: "estimated_bep_min_months", label: "BEP minimum (bulan)", type: "integer" },
  { name: "estimated_bep_max_months", label: "BEP maksimum (bulan)", type: "integer" },
  { name: "omzet_monthly_idr", label: "Omzet bulanan", type: "integer" },
  { name: "omzet_monthly_min_idr", label: "Omzet bulanan minimum", type: "integer" },
  { name: "omzet_monthly_max_idr", label: "Omzet bulanan maksimum", type: "integer" },
...
export const FranchisorSubmissionSchema = BaseSubmissionSchema.extend({
  ...
  country_code: z.string().trim().optional(),
  whatsapp: z.string().trim().min(8),
  brand_country: z.string().trim().optional(),
  target_market: z.string().trim().optional(),
