...
- `scripts/check-new-brand-review-sql.py`, `scripts/check-new-brand-review.ts`, `scripts/check-brand-match.ts`, `scripts/check-claim-workflow.ts` cover database decisions and existing-brand paths. `docs/architecture/NEW_BRAND_REVIEW.md`, `docs/README.md`, `docs/product/NEXT_STEPS.md`, `docs/product/USER_JOURNEYS.md`, `AUDIT.md`, `SUGGESTION.md`, `CODEBASE.md` and `.context/session-20260924-2325.md` document the gate, next testing step and corrected historical raw-payload findings.
