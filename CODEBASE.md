...
Last updated: 2026-06-28 15:43 (Asia/Jakarta)
...
| `css/opportunity-save.css` | Public save-opportunity button styling for generated directory cards and detail pages. | `js/opportunity-save.js`, `src/lib/franchise-static.ts`, franchise templates |
...
| `js/opportunity-save.js` | Public save-opportunity controller for generated franchise directory cards and detail pages. On click, ensures a Clerk session, redirects anonymous users to `/login?next=...`, and posts D1 saved-opportunity save/remove actions to `/profile-data`. | `css/opportunity-save.css`, `src/lib/franchise-static.ts`, `functions/profile-data.js`, public franchise templates |
