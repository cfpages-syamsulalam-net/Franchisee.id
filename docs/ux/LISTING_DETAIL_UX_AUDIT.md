...
| Category fact did not help exploration | Category is a useful browse path and should connect to similar opportunities | Linked `Kategori Franchise` to the relevant `/peluang-usaha/kategori/[slug]` page |
