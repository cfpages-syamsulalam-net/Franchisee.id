...
- `docs/architecture/OCR_PROVIDER_STRATEGY.md`: ranked OCR free-tier providers, quota-aware rotation policy, encrypted dashboard credentials, and admin-triggered OCR job integration plan.
...
- `docs/architecture/OCR_PROVIDER_STRATEGY.md`: official free-limit research, provider ranking, failover guardrails, admin-managed OCR configuration contract, and job/cache execution model.
