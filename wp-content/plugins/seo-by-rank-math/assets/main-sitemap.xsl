			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Franchise.id</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Franchise.id</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://brave-gerbil-7f0cee.instawp.site/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
